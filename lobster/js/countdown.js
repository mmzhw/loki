(function() {
  ...
  var html1 = `<div class="weibo-item">
      <div class="weibo-header clearfix">
        <div class="weibo-face">
          <img src="${weibos[random1].face}" alt="">
        </div>
        <div class="weibo-from">
          <div class="weibo-name">${weibos[random1].name}</div>
          <div class="weibo-device">${weibos[random1].time} 来自 ${weibos[random1].device}</div>
        </div>
      </div>
      <div class="weibo-body">
        <a class='topic' href='http://huati.weibo.com/k/612%E6%9C%89%E8%B1%A1%E8%99%BE%E6%90%9E%E4%B8%80%E6%B3%A2'>#女神喂我吃龙虾#</a>
        <span class='content'>${weibos[random1].content}</span>
      </div>
      <div class="weibo-tools">
        <a href="http://huati.weibo.com/k/612%E6%9C%89%E8%B1%A1%E8%99%BE%E6%90%9E%E4%B8%80%E6%B3%A2">
          <span class="zhuanfa">转发</span>
          <span class="comments">${weibos[random1].comments}</span>
          <span class="likes">${weibos[random1].likes}</span>
        </a>
      </div></div>`;
  var html2 = `<div class="weibo-item">
      <div class="weibo-header clearfix">
        <div class="weibo-face">
          <img src="${weibos[random2].face}" alt="">
        </div>
        <div class="weibo-from">
          <div class="weibo-name">${weibos[random2].name}</div>
          <div class="weibo-device">${weibos[random2].time} 来自 ${weibos[random2].device}</div>
        </div>
      </div>
      <div class="weibo-body">
        <a class='topic' href='http://huati.weibo.com/k/612%E6%9C%89%E8%B1%A1%E8%99%BE%E6%90%9E%E4%B8%80%E6%B3%A2'>#女神喂我吃龙虾#</a>
        <span class='content'>${weibos[random2].content}</span>
      </div>
      <div class="weibo-tools">
        <a href="http://huati.weibo.com/k/612%E6%9C%89%E8%B1%A1%E8%99%BE%E6%90%9E%E4%B8%80%E6%B3%A2">
          <span class="zhuanfa">转发</span>
          <span class="comments">${weibos[random2].comments}</span>
          <span class="likes">${weibos[random2].likes}</span>
        </a>
      </div></div>`
  var html3 = `<div class="weibo-item">
      <div class="weibo-header clearfix">
        <div class="weibo-face">
          <img src="${weibos[random3].face}" alt="">
        </div>
        <div class="weibo-from">
          <div class="weibo-name">${weibos[random3].name}</div>
          <div class="weibo-device">${weibos[random3].time} 来自 ${weibos[random3].device}</div>
        </div>
      </div>
      <div class="weibo-body">
        <a class='topic' href='http://huati.weibo.com/k/612%E6%9C%89%E8%B1%A1%E8%99%BE%E6%90%9E%E4%B8%80%E6%B3%A2'>#女神喂我吃龙虾#</a>
        <span class='content'>${weibos[random3].content}</span>
      </div>
      <div class="weibo-tools">
        <a href="http://huati.weibo.com/k/612%E6%9C%89%E8%B1%A1%E8%99%BE%E6%90%9E%E4%B8%80%E6%B3%A2">
          <span class="zhuanfa">转发</span>
          <span class="comments">${weibos[random3].comments}</span>
          <span class="likes">${weibos[random3].likes}</span>
        </a>
      </div></div>`
