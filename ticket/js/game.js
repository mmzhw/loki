...
const reduceTime = setInterval(() => {
  const currWidth = document.getElementById('progress-content').offsetWidth
...
// 点击计数
let clickCount = 0
document.getElementById('click-button').addEventListener('touchstart', () => {
  const currWidth = document.getElementById('progress-content').offsetWidth
